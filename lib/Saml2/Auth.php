...
//            print_r($response->getXMLDocument());
            // echo $requestId;
            // echo $response->isValid($requestId);
            if ($response->isValid($requestId)) {
                ...
                $this->_errors[] = 'invalid_response1';
     ...
     * @param bool        $raRxeM66T19YqxtmsYnGRj8ad54YaZNMp2 True if we want to use parameters from $_SERVER to validate the signature
     ...
     * @throws OneLogin_Saml2_Error
     */
    public function processSLO($keepLocalSession = false, $requestId = null, $raRxeM66T19YqxtmsYnGRj8ad54YaZNMp2 = false, $cbDeleteSession = null, $stay = false)
    {
        $this->_errors = array();
        $this->_errorReason = null;
        if (isset($_GET['SAMLResponse'])) {
            ...
            if (!$logoutResponse->isValid($requestId, $raRxeM66T19YqxtmsYnGRj8ad54YaZNMp2)) {
            ...
            if (!$logoutRequest->isValid($raRxeM66T19YqxtmsYnGRj8ad54YaZNMp2)) {
